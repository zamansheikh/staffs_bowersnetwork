...
import { Staff } from '@/types/office';
...
export default function StaffPage() {
    ...
    const handleAddStaff = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post('/api/office/staff',
                { email: newEmail, designation: newDesignation },
                { headers: { Authorization: `Bearer ${token}` } }
            );
    ...
    const handlePromoteToAdmin = async () => {
        ...
        try {
            ...
            showToast('Staff member promoted to admin', 'success');
            setShowPromoteConfirm(null);
            fetchStaff();
        } catch (error) {
            console.error('Error promoting staff:', error);
            showToast('Failed to promote staff member', 'error');
        } finally {
            setSubmitting(false);
        }
    };
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-600">Manage your office staff members</p>
                    </div>
                </div>
                <button
            ...
            >
                <div className="space-y-4">
                    <p className="text-gray-600">
                        Are you sure you want to remove <strong>{showDeleteConfirm?.email}</strong> from staff?
                    </p>
            ...
            >
                <div className="space-y-4">
                    <p className="text-gray-600">
                        Are you sure you want to promote <strong>{showPromoteConfirm?.email}</strong> to Office Admin?
                    </p>
                    <div className="flex gap-3">
                        <button
